...
@module.server
def feature_engineering_server(input: Inputs, output: Outputs, session: Session, shared_store, app_session=None,group_label=None,):
    ...
    def _save():
        ...
        emit_ga(
            "pipeline_saved",
            {
                ...
                "num_features_created": len(feature_history_store()),
            },
        )
