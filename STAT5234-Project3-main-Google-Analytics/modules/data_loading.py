...
def data_loading_server(
    ...
    shared_store, app_session=None, group_label=None,
):
    ...
    def _execute_load():
        ...
        try:
            ...
            if df.empty:
                emit_ga(
                    # track empty file failure
                    "dataset_load_failed",
                    {
                        "source_mode": load_info["type"],
                        "reason": "empty_file",
                    },
                )
            ...
            print("emit_ga dataset_loaded_success fired") # debug line 
            ...
            emit_ga(
                "dataset_load_failed",
                {
                    "source_mode": load_info["type"] if load_info is not None else None,
                    "reason": str(e),
                },
            )
