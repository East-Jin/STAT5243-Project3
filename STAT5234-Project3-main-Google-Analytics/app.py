...
def server(input: Inputs, output: Outputs, session: Session):
    ...
    data_loading_server("data_loading", shared_store=store, app_session=session, group_label="A")
    data_cleaning_server("data_cleaning", shared_store=store, app_session=session, group_label="A")
    feature_engineering_server("feature_engineering", shared_store=store, app_session=session,group_label="A")
    eda_server("eda", shared_store=store,app_session=session,group_label="A")
